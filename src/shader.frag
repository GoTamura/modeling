...
void main() {
    ...
    vec3 ambient_color = light_color.rgb * ambient_strength;
    ...
    vec3 diffuse_color = light_color.rgb * diffuse_strength;
    ...
    vec3 specular_color = object_specular.rgb * specular_strength * light_color.rgb;
